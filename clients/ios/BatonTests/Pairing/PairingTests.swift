...
struct PairingTests {
    ...
    @Test func pairingApprovalModeDefaultsToManualAndAcceptsServerAutoPolicy() throws {
        let base = #"{"protocol":"baton/1.0","pairing_id":"ps_1","expires_at":"2026-08-30T00:00:00Z","service":{"id":"service","name":"Service"},"conversation":{"id":"conv_1","title":"Conversation"},"endpoints":{"join":"https://service.example/join","approval":"https://service.example/approval","conversation":"https://service.example/conversation"}}"#
